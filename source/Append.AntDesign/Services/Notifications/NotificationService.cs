...
namespace Append.AntDesign.Services
{
    public class NotificationService
    {
        ...
        public Task Close(string key) => Unsubscribe(Notifications.Get(key).Notification);
        public void Destroy() => Notifications.notificationList.ForEach(async g => await Unsubscribe(g.Notification));
    }
}