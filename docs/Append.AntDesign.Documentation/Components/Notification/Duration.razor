...
<Codebox Title="Duration after which the notification box is closed">
    <Description>
        <p>
            how long the notification stays open. After the <code>Duration</code> time elapses, the notification closes automatically. If not specified, the default value is 4.5 seconds. If you set the <code>Duration</code> to 0, the notification box will never close automatically.
        </p>
    </Description>
    <Demo>
